	...
	class archivesPostAccordionWidget extends archivesPostAccordionLib {
		...
		*/ 
		public function init() {
			...
			add_action( 'wp_ajax_avpt_getTotalPosts',array( &$this, 'avpt_getTotalPosts' ) );
			add_action( 'wp_ajax_avpt_getPosts',array( &$this, 'avpt_getPosts' ) ); 
			add_action( 'wp_ajax_avpt_getMorePosts',array( &$this, 'avpt_getMorePosts' ) );
			
			add_action( 'wp_ajax_nopriv_avpt_getTotalPosts', array( &$this, 'avpt_getTotalPosts' ) );
			add_action( 'wp_ajax_nopriv_avpt_getPosts', array( &$this, 'avpt_getPosts' ) ); 
			add_action( 'wp_ajax_nopriv_avpt_getMorePosts', array( &$this, 'avpt_getMorePosts' ) ); 
		...
		* @return  string  Render accordion panel html
		*/
		...
		*/	
		public function avpt_getMorePosts() {
			...
			*/
			...
			$avpt_default_category = (( isset( $_REQUEST["avpt_default_category"] ) && trim($_REQUEST["avpt_default_category"]) != "0")?esc_attr( $_REQUEST["avpt_default_category"] ):$category_id );			
			...
			*/	
			$_result_items = $this->getSqlResult( $_date_format, $avpt_default_category, $post_search_text, $_limit_start, $_limit_end );
		  
			require( $this->getArchivesPostAccordionTemplate( 'fronted/ajax_load_more_posts.php' ) );	
		...
		*/
		public function avpt_getPosts() {
		   ...
		   require( $this->getArchivesPostAccordionTemplate( 'fronted/ajax_load_posts.php' ) );	
